<nav x-data="{ open: false }" class="bg-white/80 backdrop-blur-md border-b border-gray-200/50 sticky top-0 z-50">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-2">
                        ...
                        <span class="font-bold text-lg bg-gradient-to-r from-amber-700 to-amber-900 bg-clip-text text-transparent hidden sm:block">
                            ActivityTracker
                        </span>
                    </a>
                </div>
                ...
                <div class="hidden space-x-1 sm:-my-px sm:ms-8 sm:flex">
                    ...
                    <x-nav-link :href="route('daily.show')" :active="request()->routeIs('daily.*')">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <div class="mr-3">
                    ...
                    @else
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-700">Member</span>
                    @endif
                </div>
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                            <div class="w-8 h-8 rounded-full bg-gradient-to-br from-amber-500 to-amber-700 flex items-center justify-center text-white text-sm font-bold mr-2">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('daily.show')" :active="request()->routeIs('daily.*')">{{ __('Daily View') }}</x-responsive-nav-link>
            <x-responsive-nav-link :href="route('activities.index')" :active="request()->routeIs('activities.*')">{{ __('Activities') }}</x-responsive-nav-link>
